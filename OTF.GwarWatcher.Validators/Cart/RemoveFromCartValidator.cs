...
{
    [EventValidator(eventId: 22)]
    public class RemoveFromCartValidator : SingleProductWithPriceValidator, IValidator, IMessageValueRequired, IMessageLabelRequired
    {
